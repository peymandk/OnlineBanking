      ...
      <div class="bodytext" style="padding:50px;">
        <form name="deposit" action="#" method="post">
          <fieldset style="text-align:left">
            <legend>
            <h2 style="color:#CC0000">Checks Deposit</h2>
            </legend>
            <table align="center">
              <tr>
                <th align="left">Deposit To:</th>
                <td><select>
        ...
        <form>
          <fieldset style="text-align:left">
            <legend>
            <h2 style="color:#CC0000">Deposit History</h2>
            </legend>
            <p>
            <h4>Select:
              <select>
